...
pub struct plugin_config {
    pub expire_url: *const array,
    pub expire_mimetypes: *const array,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[cold]
unsafe extern "C" fn mod_expire_init() -> *mut libc::c_void {
    return calloc(
...
#[cold]
unsafe extern "C" fn mod_expire_free(mut p_d: *mut libc::c_void) {
    let p: *mut plugin_data = p_d as *mut plugin_data;
    free((*p).toffsets as *mut libc::c_void);
}
unsafe extern "C" fn mod_expire_get_offset(
    mut errh: *mut log_error_st,
    mut expire: *const buffer,
    mut offset: *mut time_t,
) -> time_t {
    let mut ts: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut type_0: time_t = 0;
    let mut retts: time_t = 0 as libc::c_int as time_t;
    if buffer_is_blank(expire) != 0 {
        log_error(
            errh,
            b"src/mod_expire.c\0" as *const u8 as *const libc::c_char,
            57 as libc::c_int as libc::c_uint,
            b"mod_expire empty string\0" as *const u8 as *const libc::c_char,
        );
    ...
    {
        type_0 = 0 as libc::c_int as time_t;
        ts = ts.offset(7 as libc::c_int as isize);
        ...
        {
        type_0 = 0 as libc::c_int as time_t;
        ts = ts.offset(4 as libc::c_int as isize);
    } else if 0 as libc::c_int
            == strncmp(
                ts,
        ...
        {
        type_0 = 1 as libc::c_int as time_t;
        ts = ts.offset(13 as libc::c_int as isize);
    } else {
        log_error(
            errh,
            b"src/mod_expire.c\0" as *const u8 as *const libc::c_char,
            74 as libc::c_int as libc::c_uint,
            b"invalid <base>: %s\0" as *const u8 as *const libc::c_char,
            ts,
        );
        return -(1 as libc::c_int) as time_t;
    }
    ...
    {
        ts = ts.offset(5 as libc::c_int as isize);
    }
    loop {
        let mut space: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut err: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut num: libc::c_int = 0;
        space = strchr(ts, ' ' as i32);
        if space.is_null() {
            log_error(
                errh,
                b"src/mod_expire.c\0" as *const u8 as *const libc::c_char,
                89 as libc::c_int as libc::c_uint,
                b"missing space after <num>: %s\0" as *const u8 as *const libc::c_char,
                ts,
            );
            return -(1 as libc::c_int) as time_t;
        }
        num = strtol(ts, &mut err, 10 as libc::c_int) as libc::c_int;
        if *err as libc::c_int != ' ' as i32 {
            log_error(
                errh,
                b"src/mod_expire.c\0" as *const u8 as *const libc::c_char,
                96 as libc::c_int as libc::c_uint,
                b"missing <type> after <num>: %s\0" as *const u8 as *const libc::c_char,
                ts,
            );
            return -(1 as libc::c_int) as time_t;
        }
        ts = space.offset(1 as libc::c_int as isize);
        space = strchr(ts, ' ' as i32);
        if space.is_null() {
            space = ((*expire).ptr).offset(buffer_clen(expire) as isize);
        }
        let mut slen: libc::c_int = 0;
        slen = space.offset_from(ts) as libc::c_long as libc::c_int;
        if *ts.offset((slen - 1 as libc::c_int) as isize) as libc::c_int == 's' as i32 {
            slen -= 1;
        }
        if slen == 4 as libc::c_int
            && 0 as libc::c_int
                == strncmp(
                    ts,
                ...
                )
        {
            num
                *= 60 as libc::c_int * 60 as libc::c_int * 24 as libc::c_int
                    * 30 as libc::c_int * 12 as libc::c_int;
        } else if slen == 5 as libc::c_int
                && 0 as libc::c_int
                    == strncmp(
                        ts,
            ...
            num
                *= 60 as libc::c_int * 60 as libc::c_int * 24 as libc::c_int
                    * 30 as libc::c_int;
        } else if slen == 4 as libc::c_int
                && 0 as libc::c_int
                    == strncmp(
                        ts,
                        b"week\0" as *const u8 as *const libc::c_char,
                        slen as libc::c_ulong,
                    )
            {
            num
            ...
            {
            num *= 60 as libc::c_int * 60 as libc::c_int * 24 as libc::c_int;
        } else if slen == 4 as libc::c_int
                && 0 as libc::c_int
                    == strncmp(
                        ts,
            ...
            {
            num *= 60 as libc::c_int * 60 as libc::c_int;
        } else if slen == 6 as libc::c_int
                && 0 as libc::c_int
                    == strncmp(
                        ts,
            ...
            log_error(
                ...
                b"unknown type: %s\0" as *const u8 as *const libc::c_char,
                ts,
            );
            return -(1 as libc::c_int) as time_t;
        }
        retts += num as libc::c_long;
        if *space as libc::c_int == '\u{0}' as i32 {
            break;
        }
        ts = space.offset(1 as libc::c_int as isize);
        if !(*ts != 0) {
...
unsafe extern "C" fn mod_expire_merge_config_cpv(
...
unsafe extern "C" fn mod_expire_merge_config(
    pconf: *mut plugin_config,
...
unsafe extern "C" fn mod_expire_patch_config(r: *mut request_st, p: *mut plugin_data) {
    (*p).conf = (*p).defaults;
...
#[cold]
unsafe extern "C" fn mod_expire_set_defaults(
    mut srv: *mut server,
    ...
    if config_plugin_values_init(
        ...
        cpk.as_ptr(),
        b"mod_expire\0" as *const u8 as *const libc::c_char,
    ) == 0
    {
    ...
    while i < (*p).nconfig {
        ...
        while -(1 as libc::c_int) != (*cpv).k_id {
            let mut a: *const array = 0 as *const array;
            match (*cpv).k_id {
                0 => {
                    a = (*cpv).v.a;
                }
                1 => {
                    ...
                    while k < (*(*cpv).v.a).used {
                        ...
                        let mut klen: size_t = buffer_clen(&mut (*ds).key) as size_t;
                        if klen != 0
                            && *((*ds).key.ptr)
                                .offset(
                                    klen.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                                        as isize,
            ...
            if !a.is_null() && (*a).used != 0 {
                (*p)
                    .toffsets = realloc(
                    (*p).toffsets as *mut libc::c_void,
                    (::std::mem::size_of::<time_t>() as libc::c_ulong)
                        .wrapping_mul(
                            ((*p).tused)
                                .wrapping_add(
                                    ((*a).used).wrapping_mul(2 as libc::c_int as libc::c_uint),
                                ) as libc::c_ulong,
                        ),
                ) as *mut time_t;
                let mut toff: *mut time_t = ((*p).toffsets).offset((*p).tused as isize);
                let mut k_0: uint32_t = 0 as libc::c_int as uint32_t;
                while k_0 < (*a).used {
                    let mut v: *mut buffer = &mut (*(*((*a).data).offset(k_0 as isize)
                        as *mut data_string))
                        .value;
                    *toff = mod_expire_get_offset(
                        (*srv).errh,
                        v,
                        toff.offset(1 as libc::c_int as isize),
                    );
                    if -(1 as libc::c_int) as libc::c_long == *toff {
                        log_error(
                            (*srv).errh,
                            b"src/mod_expire.c\0" as *const u8 as *const libc::c_char,
                            225 as libc::c_int as libc::c_uint,
                            b"parsing %s failed: %s\0" as *const u8
                    ...
                    toff = toff.offset(2 as libc::c_int as isize);
                    (*p)
                        .tused = ((*p).tused as libc::c_uint)
        ...
        && (*(*p).cvlist).v.u2[1 as libc::c_int as usize] != 0
    {
        ...
        if -(1 as libc::c_int) != (*cpv_0).k_id {
            mod_expire_merge_config(&mut (*p).defaults, cpv_0);
        }
    }
    return HANDLER_GO_ON;
}
unsafe extern "C" fn mod_expire_set_header(
    r: *mut request_st,
    off: *const time_t,
) -> handler_t {
    let cur_ts: unix_time64_t = log_epoch_secs;
    let mut expires: unix_time64_t = *off.offset(1 as libc::c_int as isize);
    if 0 as libc::c_int as libc::c_long == *off.offset(0 as libc::c_int as isize) {
        expires += cur_ts;
    } else {
        ...
        expires += (*st).st_mtim.tv_sec;
    }
    if expires < cur_ts {
        expires = cur_ts;
    }
    let mut vb: *mut buffer = 0 as *mut buffer;
    if (*r).http_version as libc::c_int > HTTP_VERSION_1_0 as libc::c_int {
        ...
        if http_date_time_to_str(
            buffer_extend(vb, (30 as libc::c_int - 1 as libc::c_int) as size_t),
        ...
        ) == 0
        {
            buffer_truncate(
                vb,
                ((*vb).used).wrapping_sub(30 as libc::c_int as libc::c_uint),
            );
        }
    }
    return HANDLER_GO_ON;
}
unsafe extern "C" fn mod_expire_handler(
    ...
    if (*r).http_status != 200 as libc::c_int && (*r).http_status != 206 as libc::c_int {
        return HANDLER_GO_ON;
    }
    ...
    ds = if !((*p).conf.expire_url).is_null() {
        array_match_key_prefix((*p).conf.expire_url, &mut (*r).uri.path)
            as *const data_string
    } else {
        0 as *const data_string
    };
    if ds.is_null() {
        if ((*p).conf.expire_mimetypes).is_null() {
            return HANDLER_GO_ON;
        }
        vb = http_header_response_get(
            r,
        ...
        if !vb.is_null() {
            ds = array_match_key_prefix((*p).conf.expire_mimetypes, vb)
                as *const data_string;
        }
        if ds.is_null() {
    ...
    return mod_expire_set_header(r, ((*p).toffsets).offset((*ds).value.used as isize));
}
#[no_mangle]
pub unsafe extern "C" fn mod_expire_plugin_init(mut p: *mut plugin) -> libc::c_int {
    (*p).version = 0x10440 as libc::c_int as size_t;
    (*p).name = b"expire\0" as *const u8 as *const libc::c_char;
    (*p)
        .init = ::std::mem::transmute::<
        Option::<unsafe extern "C" fn() -> *mut libc::c_void>,
        Option::<unsafe extern "C" fn() -> *mut libc::c_void>,
    >(Some(mod_expire_init as unsafe extern "C" fn() -> *mut libc::c_void));
    (*p)
        .cleanup = Some(
        mod_expire_free as unsafe extern "C" fn(*mut libc::c_void) -> (),
    );
    (*p)
        .set_defaults = Some(
    ...
    cpk = [
        {
            let mut init = config_plugin_keys_t {
                k: b"expire.url\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = config_plugin_keys_t {
                k: b"expire.mimetypes\0" as *const u8 as *const libc::c_char,
